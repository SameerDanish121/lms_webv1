...
<body class="bg-gradient-to-r from-blue-300 via-blue-200 to-blue-100 min-h-screen p-0 m-0">
    ...
    <div class="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-6 mt-6 text-center">
        ...
        <h2 class="text-2xl font-bold text-gray-700 mb-4">Upload Student Enrollments</h2>
        ...
        try {
           await initializeApiBaseUrl();
            ...
            if (response.status === 200) {
                ...
                showAlert(`Upload Successful!\nTotal Record Per Line (Student RegNo): ${result.data["Total Student Rows"]}\nSuccessfully Added Records Count: ${result.data["Added Enrollments"]}\nFaulty Records Count: ${result.data["Failed Enrollments"]}`, 'success');
            } else {
                hideLoader();
