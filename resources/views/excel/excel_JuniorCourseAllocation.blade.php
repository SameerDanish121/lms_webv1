...
<head>
    ...
    <title>LMS -Junior Course Allocation</title>
...
<body class="bg-gradient-to-r from-blue-300 via-blue-200 to-blue-100 min-h-screen p-0 m-0">
    ...
    <div class="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-6 mt-6 text-center">
        ...
        <h2 class="text-2xl font-bold text-gray-700 mb-4">Upload Junior Course Allocations List for A Session</h2>
...
<script>
    ...
    document.getElementById("submitButton").addEventListener("click", async function() {
        ...
        try {
            initializeApiBaseUrl();
            let response = await fetch(`${API_BASE_URL}api/Uploading/excel-upload/assign-juniorlecturer`, {
                method: "POST"
                , body: formData
            , });
            ...
            if (response.status === 200) {
                ...
                showAlert(`Upload Successful!\nTotal Record Per Line : ${result["Total Records"]}\nSuccessfully Added Records Count: ${result["Added"]}\nFaulty Records Count: ${result["Failed"]}`, 'success');
            } else {
                hideLoader();
