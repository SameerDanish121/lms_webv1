    ...
    <div class="container mx-auto bg-white shadow-lg rounded-lg p-6">
        ...
        <div class="flex items-center mb-4 space-x-3">
            <div class="relative w-1/3">
                <input type="text" id="searchInput" placeholder="Search by RegNo or Name"
                    class="border p-3 rounded w-full pl-10 focus:outline-blue-500">
        ...
        const dummyData = [
            {
                ...
                students: [
                    { img: "https://via.placeholder.com/50", regNo: "001", name: "Ahmed", labAttended: 7, labPercentage: 70, classAttended: 25, classPercentage: 83, totalPercentage: 80 },
                    { img: "https://via.placeholder.com/50", regNo: "002", name: "Aisha", labAttended: 8, labPercentage: 80, classAttended: 28, classPercentage: 93, totalPercentage: 90 }
                ]
            },
            {
                ...
                students: [
                    { img: "https://via.placeholder.com/50", regNo: "003", name: "Zain", labAttended: 6, labPercentage: 75, classAttended: 22, classPercentage: 78, totalPercentage: 77 },
                    { img: "https://via.placeholder.com/50", regNo: "004", name: "Sara", labAttended: 7, labPercentage: 88, classAttended: 24, classPercentage: 85, totalPercentage: 84 }
                ]
            }
        ];
