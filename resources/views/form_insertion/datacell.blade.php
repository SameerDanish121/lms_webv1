...
<body class="bg-gradient-to-r from-blue-300 via-blue-200 to-blue-100 min-h-screen p-0 m-0">
    ...
    <div class="flex items-center justify-center p-10">
        <div class="w-4/5 bg-white shadow-lg rounded-lg p-10">
            <h2 class="text-3xl font-bold text-center text-orange-500 mb-6">Add New Datacell</h2>
            <form id="adminForm" class="grid grid-cols-2 gap-8">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500" required>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex space-x-2">
                            ...
                            <select id="countryCode" class="w-1/4 px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500">
                            ...
                            <!-- Phone Number Input -->
                            <input type="tel" id="phone" class="w-3/4 px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500" required>
                        </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="designation" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500" required>
                    </div>
                </div>
