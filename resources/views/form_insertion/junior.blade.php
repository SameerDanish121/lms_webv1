...
<body class="bg-gradient-to-r from-blue-300 via-blue-200 to-blue-100 min-h-screen p-0 m-0">
    ...
    <div class="flex items-center justify-center p-10">
        <div class="w-4/5 bg-white shadow-lg rounded-lg p-10">
            <h2 class="text-3xl font-bold text-center text-orange-500 mb-6">Add New Junior Lecturer</h2>
    ...
    function hideLoader() {
        ...
        async function submitForm() {
            ...
            try {
                let response = await fetch(`${API_BASE_URL}api/Insertion/add-single-junior`, {
                    method: "POST",
                    body: formData
                });
